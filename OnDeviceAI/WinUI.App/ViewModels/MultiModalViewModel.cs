...
using WinUI.App.Contracts.ViewModels;

namespace WinUI.App.ViewModels;
...
public partial class MultiModalViewModel : ObservableRecipient, INavigationAware
{
    ...
    public MultiModalViewModel(IWebViewService webViewService)
    {
